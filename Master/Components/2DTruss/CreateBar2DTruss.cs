...
{
    public class CreateBar2DTruss : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the CreateBar2DTruss class.
        /// </summary>
        public CreateBar2DTruss()
          : base("CreateBar2DTruss", "Nickname",
              "Description",
               "Panda", "2DTruss")
        {
        }
        ...
        {
            get { return new Guid("683BC083-67E2-4875-A454-ACB45DB58B4B"); }
        }
    }
}